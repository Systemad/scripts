...
KBUILD_BUILD_USER=weeb-twrp-user
KBUILD_BUILD_HOST=weeb-twrp-host
export KBUILD_BUILD_USER KBUILD_BUILD_HOST

# Get CI environment
CI_ENVIRONMENT="SEMAPHORE_CI"
PROJECT_DIR=/home/dan/Documents/Android
CUR_BUILD_NUM="555"
KERNEL_DIR=/home/dan/Documents/Android/weeb_kernel_oneplus_sm8150
...
#NEW_BOOT_IMG_NAME="twrp-boot.img"
cd ${PROJECT_DIR}
#fi
